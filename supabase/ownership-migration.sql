...
alter table public.purchases add column if not exists supplier_invoice_date timestamptz;
alter table public.purchases add column if not exists purchase_type text;
alter table public.purchases add column if not exists purchase_from text;
alter table public.purchases add column if not exists payment_terms text;
alter table public.purchases add column if not exists due_date timestamptz;
alter table public.purchase_items add column if not exists discount_rate numeric(8,3);
alter table public.purchase_items add column if not exists extra_discount_rate numeric(8,3);
alter table public.purchase_items add column if not exists extra_discount numeric(14,2);
alter table public.purchase_items add column if not exists gst_rate numeric(8,3);
alter table public.purchase_items add column if not exists gst_amount numeric(14,2);
